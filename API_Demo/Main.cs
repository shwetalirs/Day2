/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘API_Demo.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"">
  <Body>
    <GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>Frankfurt</DepartureCity><ArrivalCity>London</ArrivalCity><FlightDate>2020-08-14T00:00:00+00:00</FlightDate></GetFlights>
  </Body>
</Envelope>");
            ...
            _flow.StServiceCallActivity4.IsSkip = false;
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance"">
  <Body>
    <UpdateFlightOrder xmlns=""HP.SOAQ.SampleApp""><UpdateFlightOrderDetails><CustomerName>Shwetali</CustomerName><NumberOfTickets></NumberOfTickets><OrderNumber></OrderNumber></UpdateFlightOrderDetails></UpdateFlightOrder>
  </Body>
</Envelope>");
            ...
            _flow.StServiceCallActivity6.Name = @"UpdateFlightOrder";
            ...
            _flow.StServiceCallActivity6.TransportProtocol.SOAPProperties.SoapAction = @"HP.SOAQ.SampleApp/IFlightsSoapService/UpdateFlightOrder";
            ...
            _flow.StServiceCallActivity6.Operation = @"UpdateFlightOrder";
            _flow.StServiceCallActivity6.IsOneWay = false;
            _flow.StServiceCallActivity6.IsSkip = true;
    ...
    <GetFlightOrders xmlns=""HP.SOAQ.SampleApp"">
      <FlightsDetails>
        <CustomerName></CustomerName><OrderNumber></OrderNumber>
            ...
            _flow.StServiceCallActivity5.IsSkip = true;
